...
var button = [{ buttonId: `allmenu`, buttonText: { displayText: `List menu` }, type: 1 }, { buttonId: `donasi`, buttonText: { displayText: `Sewa` }, type: 1 }, { buttonId: `rules`, buttonText: { displayText: `Rules` }, type: 1 }]
...
ALYA.sendListMsg(m.chat, `Sistem otomatis (Bot WhatsApp) yang dapat membantu untuk melakukan sesuatu, mencari dan mendapatkan data/informasi hanya melalui WhatsApp

Persyaratan dalam menggunakan bot sudah jelas pasti ada, untuk menghindari spam dan lain lain sebagainya

Dengan menggunakan bot ini maka anda setuju dengan Syarat dan Ketentuan yang sudah di tetapkan`, '', '', `Klik!`, sections, loh)
}
break
case 'menugc':{
var no = 1
return m.reply(`*GROUP MENU*
› ${prefix}.linkgroup
